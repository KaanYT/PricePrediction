...
<#  Example
    ...
    Change-Network-Settings -ConfigPath $ConfigPath -Epochs 100 -BatchSize 100 -SequenceLength 100 -Criterion "100" -Optimizer "100" -HiddenSize -5 -UseGPU $true
    ...
    Run-Python-Script -ScriptPath $Location -CondaEnv $CondaEnvirment -CommandLineArguments "-n" # -n,-o -v -w -f -h
    ShutDown-With-Popup
#>
