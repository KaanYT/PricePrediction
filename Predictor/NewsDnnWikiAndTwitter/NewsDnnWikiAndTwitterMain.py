...
from Predictor.NewsDnnWikiAndTwitter.NewsDnnWikiAndTwitterModel import NewsDnnWikiAndTwitterModel
from Predictor.NewsDnnWikiAndTwitter.NewsDnnWikiAndTwitterDataReader import NewsDnnWikiAndTwitterDataReader
...
class NewsDnnWikiAndTwitterMain(object):
    ...
    def __init__(self, epochs, batch_size, seq_length, lr=0.005):
        ...
        self.model: NewsDnnWikiAndTwitterModel = NewsDnnWikiAndTwitterModel(input_size=102, lr=lr, use_gpu=self.config["training"]["useGPU"])
        self.reader = NewsDnnWikiAndTwitterDataReader(self.config['data'], batch_size, seq_length)
        self.timer = Timer()
    ...
    def save_model(self):
        ...
        checkpoint = {
            'model': NewsDnnWikiAndTwitterModel(),
